...
const Task = ({ key, list, task, onRemove }) => {
    return (
        <li key={key} className="tasks__items-item">
            <div className="checkbox">
                <input type="checkbox" className="checkbox__input" />
                <label className="checkbox__label">
                    <div className="checkbox__content">
                        <div className="checkbox__input-custom">
                        ...
                        <input type="text" className="checkbox__text" defaultValue={task.text} />
                    </div>
                </label>
            </div>
            <div className="tasks__items-item-remove" onClick={() => onRemove(list.id, task.id)}>
