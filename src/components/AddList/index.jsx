...
const AddButtonList = ({ onAdd, colors }) => {
    ...
    const addList = () => {
        ...
        axios
            ...
            .then(({ data }) => {
                const color = colors.filter(color => color.id === chosenColor)[0];
                const addListObj = { ...data, color, tasks: [] };
                onAdd(addListObj);
                onCloseAddList();
            })
            .catch(() => {
    ...
    return (
        <div className="add-list">
            ...
            {visiblePopup && <div className="add-list-popup">
                <div className="add-list-popup__close" onClick={() => onCloseAddList()}>
                ...
                <div className="add-list-popup__inner">
                    ...
                    <button onClick={addList} className={`add-list-popup__btn btn btn--primary btn--wide ${isLoading ? 'btn--loading' : ''}`}>
